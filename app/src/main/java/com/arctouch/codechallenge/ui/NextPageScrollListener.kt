...
abstract class NextPageScrollListener(layoutManager: LinearLayoutManager) : RecyclerView.OnScrollListener() {
    ...
    override fun onScrolled(view: RecyclerView?, dx: Int, dy: Int) {
        ...
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount) {
            currentPage++
            onFetchNextPage(currentPage, totalItemCount, view)
            loading = true
        }
    }
    ...
    abstract fun onFetchNextPage(page: Int, totalItemsCount: Int, view: RecyclerView?)
}